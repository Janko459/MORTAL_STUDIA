...
public class JankoMovP2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.W) && (_onGround || _maxJump > _currentJump))
        {
            _onGround = false;
            ...
            if (Input.GetKeyDown(KeyCode.W) && (_maxJump > _currentJump))
            {
    ...
    void TakeTire1()
    {
        this.GetComponent<P2FighterHP>().UseStamina(tire);
    }
    void TakeTire2()
    {
        this.GetComponent<P2FighterHP>().UseStamina(tire2);
    }
    void TakeTire3()
    {
        this.GetComponent<P2FighterHP>().UseStamina(tire3);
    }
}
